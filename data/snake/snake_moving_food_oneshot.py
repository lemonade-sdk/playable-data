# CREATE: snake where the food moves

"""
Snake Moving Food Game

A snake game where the player controls a snake to collect food that moves to random
adjacent positions each game update. The food repositions itself dynamically, making
collection more challenging than static food placement. Implementation uses pygame
with grid-based movement, collision detection, and dynamic food positioning logic.
"""
