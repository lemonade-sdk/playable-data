...
A remix of the classic Snake game where an enemy chases the snake, adding
a new layer of challenge. The enemy uses simple AI to pursue the snake's head
and will end the game if it catches the snake.
