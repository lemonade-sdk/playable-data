# CREATE: snake with two players

"""
Snake Two Player Game

A competitive snake game where two players control separate snakes on the same
board. Player 1 uses arrow keys, Player 2 uses WASD controls. Both snakes compete
for food and must avoid colliding with walls, themselves, or each other. Implementation
uses pygame with dual input handling, collision detection between snakes, and
shared food spawning mechanics.
"""
