# CREATE: snake with moving food and an enemy that chases me

"""
Snake Ultimate Challenge Game

A snake game where the player controls a snake to collect food that moves to random
adjacent positions while being pursued by an AI-controlled enemy. Combines dynamic
food repositioning with enemy pursuit mechanics. The enemy chases the snake's head
while food constantly relocates. Implementation uses pygame with grid-based movement,
dynamic food positioning, enemy AI pathfinding, and collision detection systems.
"""
