# CREATE: snake with an enemy that chases me

"""
Snake Enemy Chase Game

A snake game where the player controls a snake to collect food while being pursued
by an AI-controlled enemy. The enemy uses pathfinding to chase the snake's head
and will end the game if it catches the snake. Implementation uses pygame with
grid-based movement, enemy AI pathfinding, collision detection, and pursuit
behavior algorithms.
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Snake Game - Enemy Chase Remix")
