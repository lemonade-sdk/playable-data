# CREATE: snake where the game speeds up when I eat food

"""
Snake Accelerating Game

A snake game where the player controls a snake to collect food, with game speed
increasing after each food item consumed. The snake grows longer and moves faster
with each meal, creating progressively more challenging gameplay. Implementation
uses pygame with grid-based movement, collision detection, and dynamic speed
scaling based on food consumption.
"""
