# CREATE: snake with two enemies that chase me

"""
Snake Dual Enemies Game

A snake game where the player controls a snake to collect food while being pursued
by two AI-controlled enemies. Both enemies use pathfinding to chase the snake's head
and will end the game if either catches the snake. Implementation uses pygame with
grid-based movement, dual enemy AI systems, collision detection, and pathfinding
algorithms for enemy pursuit behavior.
"""
