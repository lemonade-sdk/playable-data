...
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_1_bug.py", line 240, in <module>
# ERROR:     game.run_game_loop()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_1_bug.py", line 230, in run_game_loop
# ERROR:     self.update_game_state()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_1_bug.py", line 173, in update_game_state
# ERROR:     if self.snake_player.check_if_collision_occurred():
# ERROR:        ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_1_bug.py", line 93, in check_if_collision_occurred
# ERROR:     if self.segments[0] in self.segments[1]:
# ERROR:                            ~~~~~~~~~~~~~^^^
