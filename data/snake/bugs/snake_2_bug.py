...
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_2_bug.py", line 161, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_2_bug.py", line 141, in run
# ERROR:     self.draw()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_2_bug.py", line 94, in draw
# ERROR:     pygame.draw.rect(self.screen, WHITE, (self.food.pos * GRID, GRID, GRID))
# ERROR: TypeError: rect argument is invalid
...
class Game:
    ...
    def draw(self):
        ...
        pygame.draw.rect(self.screen, WHITE, (self.food.pos * GRID, GRID, GRID))
