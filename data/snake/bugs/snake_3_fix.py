...
BUG FIX: In the snake rendering method, an undefined color constant is used.
Check what color constants are defined at the top of the file versus what's
being used when drawing the snake.
"""
...
class GameController:
    ...
    def _render_snake(self):
        ...
        # Fixed: use correct constant name GREEN instead of SNAKE_COLOR
