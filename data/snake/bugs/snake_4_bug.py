...
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_4_bug.py", line 256, in <module>
# ERROR:     game_engine.execute()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_4_bug.py", line 245, in execute
# ERROR:     self.process()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_4_bug.py", line 180, in process
# ERROR:     self.snake.process_movement()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_4_bug.py", line 62, in process_movement
# ERROR:     new_x = current_head[0] + self.heading[0]
# ERROR:                               ^^^^^^^^^^^^
# ERROR: AttributeError: 'SnakeBody' object has no attribute 'heading'
...
class SnakeBody:
    ...
    def process_movement(self):
        ...
        new_x = current_head[0] + self.heading[0]
        new_y = current_head[1] + self.heading[1]
