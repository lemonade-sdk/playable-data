...
BUG FIX: In the draw method when rendering the snake, the attribute name used
doesn't match the one defined in the Snake class. Check what the snake's body
segments are called in the Snake __init__ versus what's used in the draw loop.
"""
...
class Game:
    ...
    def draw(self):
        ...
        # Draw snake
        # Fixed: use correct attribute name self.snake.body instead of self.snake.segments
