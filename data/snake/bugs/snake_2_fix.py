...
BUG FIX: In the draw method when rendering food, the rect coordinates are computed
incorrectly. Look at how the snake is drawn versus how food is drawn - the food
position needs to be converted to pixel coordinates properly.
"""
...
class Game:
    ...
    def draw(self):
        ...
        # Fixed: unpack food position and multiply coordinates by GRID size
        fx, fy = self.food.pos
