...
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_3_bug.py", line 248, in <module>
# ERROR:     main()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_3_bug.py", line 244, in main
# ERROR:     controller.start()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_3_bug.py", line 234, in start
# ERROR:     self.render()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_3_bug.py", line 193, in render
# ERROR:     self._render_snake()
# ERROR:   File "C:\work\lsdk\playable-data\data\snake\bugs\snake_3_bug.py", line 204, in _render_snake
# ERROR:     pygame.draw.rect(self.display, SNAKE_COLOR, rect)
# ERROR:                                    ^^^^^^^^^^^
# ERROR: NameError: name 'SNAKE_COLOR' is not defined
...
class GameController:
    ...
    def _render_snake(self):
        ...
        for x, y in self.snake.get_all_positions():
            ...
            pygame.draw.rect(self.display, SNAKE_COLOR, rect)
