...
BUG FIX: In the SnakeBody's process_movement method, incorrect attribute names are
used for the direction and growth flag. Check what these attributes are called
in __init__ versus what's used in process_movement.
"""
...
class SnakeBody:
    ...
    def process_movement(self):
        ...
        # Fixed: use correct attribute names self.direction and self.needs_to_grow
