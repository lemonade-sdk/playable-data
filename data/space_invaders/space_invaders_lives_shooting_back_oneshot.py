# CREATE: space invaders with 3 lives where the invaders shoot back

"""
Space Invaders Lives Shooting Back Game

A space shooter where the player controls a ship with three lives to destroy invading
aliens that fire bullets back at the player. The player can be hit multiple times
before game over, with lives tracked and displayed on screen. Invaders shoot with
random timing patterns requiring dodging while attacking. Implementation uses pygame
with life tracking, bidirectional bullet systems, enemy AI shooting, and collision
...
ENEMY_SHOOT_CHANCE = 0.004  # Increased shooting frequency
STARTING_LIVES = 3
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Three Lives + Shooting Back")
