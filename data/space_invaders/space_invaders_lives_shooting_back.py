...
Combination remix featuring a three lives system where the player can be hit
multiple times before the game ends, plus invaders that shoot back at the player.
Lives are displayed on screen and player respawns with invulnerability after being hit.
Based on space_invaders_three_lives.py with enhanced enemy shooting mechanics.
"""
