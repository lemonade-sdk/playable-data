...
Remix allowing player to move in 2 dimensions (up/down and left/right) instead
of just horizontal movement. Player can now dodge enemy bullets more effectively
by moving vertically within the lower portion of the screen.
