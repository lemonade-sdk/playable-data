# CREATE: space invaders with exploding bullets and 2D movement

"""
Space Invaders Exploding 2D Game

A space shooter where the player controls a ship that can move in both horizontal
and vertical directions within the lower screen area, while firing exploding bullets
through a powerup system. Player can collect powerups for explosive ammunition that
destroys multiple invaders within blast radius. Implementation uses pygame with 2D
movement controls, powerup mechanics, explosion systems, and collision detection.
"""
...
POWERUP_SPAWN_CHANCE = 0.002  # Probability per frame (increased for visibility)
EXPLOSION_RADIUS = 60
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Exploding Bullets + 2D Movement")
