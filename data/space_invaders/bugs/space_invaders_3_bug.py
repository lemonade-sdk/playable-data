...
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_3_bug.py", line 324, in <module>
# ERROR:     main()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_3_bug.py", line 320, in main
# ERROR:     engine.execute()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_3_bug.py", line 309, in execute
# ERROR:     self.update_game()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_3_bug.py", line 195, in update_game
# ERROR:     self._update_invaders()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_3_bug.py", line 225, in _update_invaders
# ERROR:     self.invaders[i].descend_and_reverse()
# ERROR:     ~~~~~~~~~~~~~^^^
...
class GameEngine:
    ...
    def _update_invaders(self):
        ...
        if should_descend:
            for i in range(len(self.invaders) + 1):
                self.invaders[i].descend_and_reverse()
