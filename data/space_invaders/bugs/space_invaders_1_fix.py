...
BUG FIX: When rendering the score, a string is being concatenated with an integer
without converting the integer to a string first. Find where the score is displayed
and ensure numeric values are converted to strings before concatenation.
"""
...
class GameController:
    ...
    def render_game(self):
        ...
        # Render score
        # Fixed: convert score to string with str() or use f-string
