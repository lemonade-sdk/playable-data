...
BUG FIX: In the Ship's draw method, an undefined color constant is used. Check
what color constants are defined at the top of the file versus what's used
when drawing the ship.
"""
...
class Ship:
    ...
    def draw(self, scr):
        # Fixed: use correct constant name GREEN instead of SHIP_COLOR
