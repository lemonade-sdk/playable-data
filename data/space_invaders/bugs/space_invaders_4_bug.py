...
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_4_bug.py", line 289, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_4_bug.py", line 280, in run
# ERROR:     self.draw()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_4_bug.py", line 240, in draw
# ERROR:     self.player.draw(self.screen)
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_4_bug.py", line 53, in draw
# ERROR:     pygame.draw.rect(screen, SPRITE_COLOR, (self.x, self.y, self.width, self.h))
# ERROR:                                                             ^^^^^^^^^^
# ERROR: AttributeError: 'PlayerCraft' object has no attribute 'width'
...
class PlayerCraft:
    ...
    def draw(self, screen):
        """Render the craft"""
        pygame.draw.rect(screen, SPRITE_COLOR, (self.x, self.y, self.width, self.h))
