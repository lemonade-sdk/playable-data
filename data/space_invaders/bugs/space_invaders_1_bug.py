...
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_1_bug.py", line 305, in <module>
# ERROR:     controller.execute_game_loop()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_1_bug.py", line 296, in execute_game_loop
# ERROR:     self.render_game()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_1_bug.py", line 263, in render_game
# ERROR:     "Score: " + self.current_score, True, PRIMARY_COLOR
# ERROR:     ~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~
...
class GameController:
    ...
    def render_game(self):
        ...
        score_surface = self.text_font.render(
            "Score: " + self.current_score, True, PRIMARY_COLOR
        )
