...
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_2_bug.py", line 213, in <module>
# ERROR:     g.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_2_bug.py", line 205, in run
# ERROR:     self.draw()
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_2_bug.py", line 178, in draw
# ERROR:     self.ship.draw(self.scr)
# ERROR:   File "C:\work\lsdk\playable-data\data\space_invaders\bugs\space_invaders_2_bug.py", line 40, in draw
# ERROR:     pygame.draw.rect(scr, SHIP_COLOR, (self.x, self.y, self.w, self.h))
# ERROR:                           ^^^^^^^^^^
# ERROR: NameError: name 'SHIP_COLOR' is not defined
...
class Ship:
    ...
    def draw(self, scr):
        pygame.draw.rect(scr, SHIP_COLOR, (self.x, self.y, self.w, self.h))
