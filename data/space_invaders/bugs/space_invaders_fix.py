...
BUG FIX: In the Invader's draw method, an incorrect attribute name is used for
the width dimension. Check what the width attribute is called in __init__ versus
what's used when drawing the rectangle.
"""
...
class Invader:
    ...
    def draw(self, screen):
        # Fixed: use correct attribute name self.width instead of self.size
        pygame.draw.rect(screen, GREEN, (self.x, self.y, self.width, self.height))
