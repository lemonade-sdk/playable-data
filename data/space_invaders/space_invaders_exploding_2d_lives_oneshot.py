# CREATE: space invaders with exploding bullets, 2D movement, and 3 lives

"""
Space Invaders Exploding 2D Lives Game

A space shooter where the player controls a ship with three lives that can move in both
horizontal and vertical directions within the lower screen area, while firing exploding
bullets through a powerup system. Player can collect powerups for explosive ammunition,
survive multiple hits with life tracking, and move freely for enhanced positioning.
Implementation uses pygame with 2D movement controls, life tracking systems, powerup
mechanics, explosion systems, and collision detection.
"""
