...
Combination remix featuring exploding bullets powerup system plus 2D player
movement. Player can collect powerups for explosive ammunition while moving
in all directions within the lower portion of the screen.
Based on space_invaders_exploding_bullets.py with 2D movement added.
"""
