# CREATE: space invaders with rainbow colored invaders

"""
Space Invaders Rainbow Game

A space shooter where the player controls a ship to destroy invading aliens that
are rendered in rainbow colors instead of standard green. Each invader displays
a different color from the rainbow spectrum for enhanced visual variety.
Implementation uses pygame with dynamic color assignment from a rainbow palette
and standard space invaders mechanics.
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Rainbow Invaders")
