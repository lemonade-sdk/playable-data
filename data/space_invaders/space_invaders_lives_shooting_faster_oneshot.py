# CREATE: space invaders with 3 lives and fast invaders that shoot back

"""
Space Invaders Lives Fast Shooting Game

A space shooter where the player controls a ship with three lives to destroy fast-moving
invading aliens that fire bullets back at the player. Invaders move at high speed in
formation while shooting with random timing patterns. The player can be hit multiple
times before game over with lives tracked on screen. Implementation uses pygame with
life tracking, accelerated enemy movement, bidirectional bullet systems, and collision
detection for both player and enemy projectiles.
"""
...
ENEMY_SHOOT_CHANCE = 0.004  # Probability per frame per invader
STARTING_LIVES = 3
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Lives + Shooting + Faster")
