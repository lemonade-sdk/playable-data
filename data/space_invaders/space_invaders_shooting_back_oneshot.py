# CREATE: space invaders where the invaders shoot back

"""
Space Invaders Shooting Back Game

A space shooter where the player controls a ship to destroy invading aliens that
fire bullets back at the player. Invaders shoot with random timing patterns,
requiring the player to dodge enemy fire while attacking. Implementation uses
pygame with bidirectional bullet systems, enemy AI shooting patterns, and
collision detection for both player and enemy projectiles.
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Shooting Back")
