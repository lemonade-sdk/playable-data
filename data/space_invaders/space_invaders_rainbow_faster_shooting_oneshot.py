# CREATE: space invaders with rainbow fast invaders that shoot back

"""
Space Invaders Rainbow Fast Shooting Game

A space shooter where the player controls a ship to destroy rainbow-colored invading
aliens that move at high speed and fire bullets back at the player. Invaders display
different rainbow colors while moving quickly in formation and shooting with random
timing patterns. Implementation uses pygame with dynamic color assignment, accelerated
movement patterns, bidirectional bullet systems, and collision detection.
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Rainbow + Faster + Shooting")
