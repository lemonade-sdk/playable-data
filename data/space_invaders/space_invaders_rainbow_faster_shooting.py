...
Triple combination remix featuring rainbow colored invaders that move 2x faster
and shoot back at the player. Combines colorful visual appeal with increased
difficulty through accelerated movement and enemy fire.
Based on space_invaders_rainbow_faster.py with shooting back mechanics added.
"""
