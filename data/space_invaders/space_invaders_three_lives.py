...
Remix with a three lives system where the player can be hit multiple times
before the game ends. Lives are displayed on screen and player respawns
after being hit until all lives are lost.
