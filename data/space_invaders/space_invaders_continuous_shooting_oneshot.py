# CREATE: space invaders where I can hold space to continuously shoot

"""
Space Invaders Continuous Shooting Game

A space shooter where the player controls a ship to destroy invading aliens with
continuous shooting capability. Holding spacebar fires bullets continuously with
a cooldown timer to prevent excessive bullet spam while maintaining responsive
controls. Implementation uses pygame with continuous input handling, fire rate
limiting, and collision detection.
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Continuous Shooting")
