...
Remix of the classic Space Invaders where invaders now shoot back at the player.
Player must dodge enemy bullets while destroying invaders. Adds enemy bullet
system with random shooting patterns and player-bullet collision detection.
Based on the original space_invaders.py implementation.
"""
