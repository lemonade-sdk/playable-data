...
Combination remix featuring rainbow colored invaders that move 2x faster than
the original. Each invader gets a different color from the rainbow spectrum
while maintaining accelerated horizontal and vertical movement speeds.
Based on space_invaders_rainbow_invaders.py with faster movement added.
"""
