# CREATE: space invaders with 2D movement, continuous shooting, and rainbow invaders

"""
Space Invaders - 2D Movement + Continuous Shooting + Rainbow Invaders Triple Combo

Triple combination remix featuring 2D player movement, continuous shooting when
holding spacebar, and rainbow colored invaders. Player can move in all directions
within a defined area, hold spacebar for rapid fire, while facing colorful
invaders rendered in rainbow spectrum colors.
Based on space_invaders_2d_continuous.py with rainbow invaders added.
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - 2D + Continuous + Rainbow")
