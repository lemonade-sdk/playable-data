...
Remix with a powerup system where player can collect powerups that make bullets
explode on impact, destroying multiple invaders in a radius. Powerups spawn
randomly and provide temporary explosive ammunition.
