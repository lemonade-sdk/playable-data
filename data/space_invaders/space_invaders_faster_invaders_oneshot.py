# CREATE: space invaders with fast-moving invaders

"""
Space Invaders Fast Game

A space shooter where the player controls a ship to destroy invading aliens that
move at high speed across and down the screen. Invaders move quickly in formation,
creating intense gameplay that requires rapid reactions and precise positioning.
Implementation uses pygame with accelerated enemy movement patterns, collision
detection, and fast-paced timing mechanics.
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Faster Invaders")
