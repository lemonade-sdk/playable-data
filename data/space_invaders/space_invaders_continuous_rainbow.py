...
Combination remix featuring continuous shooting when holding spacebar plus
rainbow colored invaders. Player can hold spacebar for rapid fire while
facing colorful invaders rendered in rainbow spectrum colors.
Based on space_invaders_continuous_shooting.py with rainbow invaders added.
"""
