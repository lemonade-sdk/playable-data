# CREATE: space invaders with continuous shooting and rainbow colored invaders

"""
Space Invaders Continuous Rainbow Game

A space shooter where the player controls a ship that can fire continuously by holding
spacebar to destroy rainbow-colored invading aliens. Invaders display different rainbow
colors while the player can maintain sustained fire with cooldown mechanics. Implementation
uses pygame with continuous input handling, fire rate limiting, dynamic color assignment,
...
SHOOT_COOLDOWN = 10  # Frames between shots when holding spacebar
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - Continuous Shooting + Rainbow")
