# CREATE: space invaders with 2D movement and continuous shooting

"""
Space Invaders 2D Continuous Game

A space shooter where the player controls a ship that can move in both horizontal
and vertical directions within the lower screen area, while firing continuously
by holding spacebar. The player can move freely within a defined area and maintain
sustained fire with cooldown mechanics. Implementation uses pygame with 2D movement
controls, continuous input handling, fire rate limiting, and collision detection.
"""
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Space Invaders - 2D Movement + Continuous Shooting")
