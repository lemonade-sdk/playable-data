...
A remix of the 2D Accelerating Ball Pong with double the acceleration rate.
The ball speeds up twice as fast with each paddle hit, creating extremely
intense and fast-paced gameplay that escalates rapidly.

Remixed from the 2D Accelerating Ball Pong implementation.
"""
