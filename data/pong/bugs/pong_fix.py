...
BUG FIX: The draw method references an attribute name that doesn't match the one created in __init__.
Check the font-related attribute names in both methods to ensure they're consistent.
"""
...
class Game:
    ...
    def draw(self):
        ...
        # Draw scores
        left_text = self.font.render(str(self.left_score), True, WHITE)  # Fixed: use self.font instead of self.text_font
        right_text = self.font.render(str(self.right_score), True, WHITE)  # Fixed: use self.font instead of self.text_font
