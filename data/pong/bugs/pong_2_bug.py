...
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_2_bug.py", line 196, in <module>
# ERROR:     g.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_2_bug.py", line 188, in run
# ERROR:     self.draw()
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_2_bug.py", line 168, in draw
# ERROR:     t1 = self.f.render("Score: " + self.sc1, True, WHITE)
# ERROR:                        ~~~~~~~~~~^~~~~~~~~~
...
class Game:
    ...
    def draw(self):
        ...
        # Scores
        t1 = self.f.render("Score: " + self.sc1, True, WHITE)
        t2 = self.f.render("Score: " + self.sc2, True, WHITE)
