...
BUG FIX: The draw_scores method uses attribute names that don't match the ones
defined in initialize_game. Check what the score attributes are named when created
versus what names are used when displaying them.
"""
...
class PongGame:
    ...
    def draw_scores(self):
        """Draw player scores"""
        # Fixed: use correct attribute names self.left_player_score and self.right_player_score
