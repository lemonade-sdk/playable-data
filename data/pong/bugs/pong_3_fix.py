...
BUG FIX: The BallEntity's update method references velocity attributes with
incorrect names. Check what the velocity attributes are named in __init__ versus
what names are used in the update method.
"""
...
class BallEntity:
    ...
    def update(self):
        ...
        # Fixed: use correct attribute names self.vx and self.vy
        self.x += self.vx
        self.y += self.vy
