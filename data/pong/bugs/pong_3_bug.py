...
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_3_bug.py", line 235, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_3_bug.py", line 225, in run
# ERROR:     self.update()
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_3_bug.py", line 149, in update
# ERROR:     self.ball.update()
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_3_bug.py", line 79, in update
# ERROR:     self.x += self.velocity_x
# ERROR:               ^^^^^^^^^^^^^^^
# ERROR: AttributeError: 'BallEntity' object has no attribute 'velocity_x'
