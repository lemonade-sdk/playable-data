...
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_1_bug.py", line 282, in <module>
# ERROR:     game.run_game_loop()
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_1_bug.py", line 273, in run_game_loop
# ERROR:     self.render_graphics()
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_1_bug.py", line 223, in render_graphics
# ERROR:     self.draw_scores()
# ERROR:   File "C:\work\lsdk\playable-data\data\pong\bugs\pong_1_bug.py", line 240, in draw_scores
# ERROR:     str(self.player_left_score), True, FOREGROUND_COLOR
# ERROR:         ^^^^^^^^^^^^^^^^^^^^^^
# ERROR: AttributeError: 'PongGame' object has no attribute 'player_left_score'
...
class PongGame:
    ...
    def draw_scores(self):
        ...
        left_score_text = self.score_font.render(
            str(self.player_left_score), True, FOREGROUND_COLOR
        )
        right_score_text = self.score_font.render(
            str(self.player_right_score), True, FOREGROUND_COLOR
        )
