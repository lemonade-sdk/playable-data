# CREATE: pong where the paddles can move in 2 dimensions

"""
Pong 2D Paddles Game

A two-player paddle game where paddles can move in both vertical and horizontal
directions within their respective court halves. Each paddle is constrained to
its side of the center line but can move freely within that area. Implementation
uses pygame with 2D movement controls, boundary detection, and collision physics
for enhanced positioning strategy.
"""
