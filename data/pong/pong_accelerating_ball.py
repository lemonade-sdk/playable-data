...
A remix of classic Pong where the ball gets faster each time it's hit by a paddle.
This creates progressively more challenging gameplay as rallies continue.
The ball speed resets when someone scores.
