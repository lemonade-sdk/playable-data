...
A remix combining 2D paddle movement with accelerating ball mechanics.
Both players can move their paddles in 2D within their territories while
the ball gets progressively faster with each paddle hit.

Remixed from both the 2D Paddles and Accelerating Ball versions.
"""
