# CREATE: pong where the ball speeds up on each hit

"""
Pong Accelerating Ball Game

A two-player paddle game where the ball increases speed each time it collides with
a paddle, creating progressively faster gameplay during rallies. Ball speed resets
to initial value when a point is scored. Implementation uses pygame with collision
detection, speed modification mechanics, and score tracking.
"""
...
BALL_ACCELERATION = 0.5  # Speed increase per hit
MAX_BALL_SPEED = 12
WINNING_SCORE = 5
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Pong Game - Accelerating Ball Remix")
