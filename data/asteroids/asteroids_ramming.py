...
A daredevil remix of the classic Asteroids game where ramming asteroids destroys
them but hitting screen edges kills you! The ship can bulldoze through asteroids
for points but must stay within the screen boundaries. This version is based on
the original asteroids.py implementation with inverted collision mechanics.
"""
