...
A thrilling remix of the classic Asteroids game featuring a relentless enemy hunter.
An indestructible red enemy constantly chases your ship! Shooting it pushes it away
but it always comes back for more. This version is based on the original asteroids.py
implementation with added AI enemy mechanics and knockback physics.
"""
