# CREATE: asteroids where the bullets explode

"""
Asteroids Explosive Game

A space shooter where the player controls a ship to destroy asteroids with explosive bullets.
Each bullet creates an area-of-effect explosion that destroys multiple asteroids within a radius.
Fire rate is reduced to balance the increased destructive power. Implementation uses pygame
with vector-based movement, collision detection, and explosion mechanics with visual effects.
"""
