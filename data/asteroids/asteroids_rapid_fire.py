...
A high-intensity remix of the classic Asteroids game featuring continuous shooting.
Hold spacebar to unleash a rapid stream of bullets! This version is based on the
original asteroids.py implementation with enhanced firing mechanics and controlled
bullet rate to maintain balanced gameplay.
"""
