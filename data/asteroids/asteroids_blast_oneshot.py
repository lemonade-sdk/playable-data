# CREATE: asteroids where I can press enter to blast the asteroids near the ship

"""
Asteroids Blast Game

A space shooter where the player controls a ship to destroy asteroids with both bullets
and area-of-effect blast attacks. Pressing Enter triggers a blast that destroys all
asteroids within a 150-pixel radius of the ship with a cooldown timer. Implementation
uses pygame with vector-based movement, collision detection, blast mechanics, and
...
def main():
    ...
    pygame.display.set_caption("Asteroids Blast Remix")
