...
"""
Asteroids Rainbow Remix

A colorful remix of the classic Asteroids game where asteroids display vibrant
rainbow colors that change when they split. This version is based on the original
asteroids.py implementation with enhanced visual effects using HSV color cycling.
Implementation maintains the same pygame-based physics and collision detection.
"""
