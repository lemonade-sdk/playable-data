# CREATE: asteroids with an enemy that chases me where I can hold space to rapid fire

"""
Asteroids Hunter Rapid Game

A space shooter where the player controls a ship to destroy asteroids with rapid-fire
bullets while being pursued by an AI enemy hunter. The hunter constantly moves toward
the player ship and can be knocked back by bullets but not destroyed. Holding spacebar
fires bullets continuously with a controlled rate timer. Implementation uses pygame with
vector-based movement, collision detection, enemy AI pathfinding, rapid-fire mechanics,
and knockback physics.
"""
