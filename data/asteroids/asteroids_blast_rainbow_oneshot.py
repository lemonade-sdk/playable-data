# CREATE: asteroids with rainbow colors where I can press enter to blast the asteroids near the ship

"""
Asteroids Blast Rainbow Game

A space shooter where the player controls a ship to destroy asteroids with both bullets
and area-of-effect blast attacks, featuring rainbow-colored asteroids and blast effects.
Asteroids display different rainbow colors that change when they split. Pressing Enter
triggers a blast that destroys asteroids within a 150-pixel radius with rainbow-colored
visual effects. Implementation uses pygame with vector-based movement, collision detection,
blast mechanics, and dynamic color systems.
"""
