...
BUG FIX: There was a missing closing parenthesis in the spawn_asteroids() function on line 180.
The math.sqrt() call is missing its closing parenthesis - add ')' after '** 2' on line 181 and before the '< 150' comparison.
"""
...
def spawn_asteroids(count):
    ...
    for _ in range(count):
        ...
        # FIXED: Added closing parenthesis after ** 2 to properly close math.sqrt()
        while (
