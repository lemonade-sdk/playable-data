...
# ERROR:   File "C:\work\lsdk\playable-data\data\asteroids\bugs\asteroids_2_bug.py", line 282, in <module>
# ERROR:     main()
# ERROR:   File "C:\work\lsdk\playable-data\data\asteroids\bugs\asteroids_2_bug.py", line 263, in main
# ERROR:     score_surface = font.render(f"Score: {current_score}", True, (0, 255, 65))
# ERROR:                                           ^^^^^^^^^^^^^
# ERROR: UnboundLocalError: cannot access local variable 'current_score' where it is not associated with a value
