...
BUG FIX: Can't concatenate strings and integers directly with the + operator.
When displaying the score, convert the integer to a string first using str(), or use an f-string instead.
"""
    ...
    while keep_running:
        ...
        if alive:
            ...
            score_display = text_font.render(
                f"Score: {player_score}", True, (0, 255, 65)  # FIXED: Use f-string to properly format the score
            )
