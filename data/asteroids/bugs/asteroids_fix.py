...
A classic space shooter where the player controls a ship to destroy asteroids.
Implementation uses pygame with vector-based movement, collision detection,
and object-oriented design for ship, bullets, and asteroids.

BUG FIX: The 'bullets' variable was never initialized in the main() function before being used.
In the main() function, add 'bullets = []' after line 183 where the ship is created.
"""
...
def main():
    ...
    bullets = []  # FIXED: Initialize bullets list to an empty list
