...
# REMIX: add progressive wave difficulty

"""
Galaga - Exploding Bullets with Progressive Waves

Combines explosive bullet mechanics with progressive difficulty scaling.
Starts with 4 enemies and adds more each wave, while bullets create blast
radius explosions that can destroy multiple enemies with strategic shots.
"""
