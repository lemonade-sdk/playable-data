# CREATE: galaga where player can move in 2d

"""
Galaga - 2D Movement

A complete Galaga implementation where the player can move freely in 2D space through
the bottom half of the screen (up, down, left, right). The player controls a ship that
can navigate to dodge enemies and their dive-bomb attacks. Features sprite-based collision
detection with enhanced mobility for strategic positioning.
"""
