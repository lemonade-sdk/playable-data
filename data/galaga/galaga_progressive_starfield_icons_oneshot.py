# CREATE: galaga with progressive waves, star field, and icon lives

"""
Galaga - Progressive Waves, Star Field, and Icon Lives

A complete Galaga implementation featuring progressive wave difficulty scaling from 4 to 32 enemies,
an animated parallax star field background that creates depth and movement, and visual life display
using ship icons. Enemy ships perform swooping attack patterns in formation.
"""
