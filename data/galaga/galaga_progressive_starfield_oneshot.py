# CREATE: galaga with progressive waves and star field

"""
Galaga - Progressive Difficulty with Star Field

A complete Galaga implementation featuring progressive wave difficulty that scales from
4 enemies upward with each wave, combined with an animated parallax star field background
that creates depth and movement through space. Enemy ships perform swooping attack patterns
in increasingly large formations.
"""
