# CREATE: galaga that starts with 4 enemies and adds more in each wave

"""
Galaga - Progressive Waves

A complete Galaga implementation featuring progressive difficulty that starts with 4 enemies
and adds more enemies with each wave, gradually increasing the challenge. The player controls
a ship at the bottom, shooting at enemies that move in formation and occasionally dive-bomb.
Features sprite-based collision detection, enemy AI with formation and attack patterns, and
dynamic wave spawning with scaling difficulty.
"""
