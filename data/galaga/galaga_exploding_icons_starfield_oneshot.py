# CREATE: galaga with exploding bullets, icon lives, and star field

"""
Galaga - Exploding Bullets, Icon Lives, and Star Field

A complete Galaga implementation featuring explosive bullets with blast radius damage,
visual life display using ship icons for remaining lives, and an animated parallax star
field background. Enemy ships perform swooping attack patterns while the player defends
