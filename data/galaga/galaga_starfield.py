# SOURCE: galaga.py
# REMIX: star field in the background

"""
Galaga - Classic arcade shooter (Star Field Remix)

This remix adds an animated star field background that scrolls continuously,
creating a sense of movement through space. The player controls a ship at the
bottom, shooting at enemies that move in formation and occasionally dive-bomb.
Features sprite-based collision detection with parallax star field effect.
"""
...
class Star:
    def __init__(self):
        ...
        # Bigger stars are brighter and faster
        if self.speed >= 2:
            self.color = WHITE
            self.size = 2
        elif self.speed >= 1.5:
