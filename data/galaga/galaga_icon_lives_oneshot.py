# CREATE: galaga with icon lives display

"""
Galaga - Icon Lives

A complete Galaga implementation featuring visual life display using ship icons at the
bottom of the screen. The player controls a ship at the bottom, shooting at enemies that
move in formation and occasionally dive-bomb. Features sprite-based collision detection
with arcade-style visual life indicators.
"""
