# CREATE: galaga with exploding bullets and progressive waves

"""
Galaga - Exploding Bullets with Progressive Waves

A complete Galaga implementation featuring explosive bullet mechanics with progressive
difficulty scaling. Starts with 4 enemies and increases each wave, while bullets create
blast radius explosions that can destroy multiple enemies with strategic shots. Enemy
ships perform swooping attack patterns in increasingly large formations.
"""
        ...
        if len(self.enemies) == 0:
            ...
            for row in range(rows):
                for col in range(cols):
                    ...
                    enemy_type = 0 if row == 0 else (1 if row == 1 else 2)
