# CREATE: galaga with explosive bullets, progressive waves, and star field

"""
Galaga - Exploding Bullets, Progressive Waves, and Star Field

A complete Galaga implementation featuring explosive bullets with blast radius damage,
progressive wave difficulty that scales from 4 to 32 enemies, and an animated parallax
star field background. Enemy ships perform swooping attack patterns while the player
defends with area-of-effect weapons.
"""
