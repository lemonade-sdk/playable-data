# CREATE: galaga with 2D movement, star field, and icon lives

"""
Galaga - 2D Movement, Star Field, and Icon Lives

A complete Galaga implementation featuring free 2D player movement through the bottom half
of the screen, an animated parallax star field background, and visual life display using
ship icons. Enemy ships perform swooping attack patterns while the player has full mobility.
"""
