# SOURCE: galaga_progressive_starfield.py
# REMIX: add icon-based life display

"""
Galaga - Progressive Waves, Star Field, and Icon Lives

Combines three remix features: progressive wave difficulty (4 → 32 enemies),
animated parallax star field background, and visual life display using ship icons.
"""
