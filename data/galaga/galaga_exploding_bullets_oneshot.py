# CREATE: galaga with exploding bullets

"""
Galaga - Exploding Bullets

A complete Galaga implementation featuring explosive bullets that create a blast radius
when they hit enemies, allowing the player to destroy multiple enemies with a single
well-placed shot. The player controls a ship at the bottom, shooting at enemies that
move in formation and occasionally dive-bomb. Features sprite-based collision detection
and explosion effects with area damage.
"""
