# SOURCE: galaga.py
# REMIX: show lives with ship icons instead of numbers

"""
Galaga - Classic arcade shooter (Icon Lives Remix)

This remix displays remaining lives using ship icons at the bottom of the screen
instead of a numerical counter, providing a more visual and arcade-authentic experience.
The player controls a ship at the bottom, shooting at enemies that move in formation
and occasionally dive-bomb. Features sprite-based collision detection and visual life display.
"""
...
def main():
    ...
    while running:
        ...
        # Draw lives as ship icons at bottom left
