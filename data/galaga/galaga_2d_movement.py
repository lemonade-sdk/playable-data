# SOURCE: galaga.py
# REMIX: player can move in 2d

"""
Galaga - Classic arcade shooter (2D Movement Remix)

This remix allows the player to move freely in 2D space (up, down, left, right)
instead of being confined to the bottom of the screen. The player controls a ship
that can navigate anywhere to dodge enemies and their dive-bomb attacks. Implements
sprite-based collision detection with unrestricted movement.
"""
...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # 2D movement - can move in all directions
        ...
        # Keep player on screen with buffer zone at top for enemies
        self.rect.left = max(0, self.rect.left)
        self.rect.right = min(WIDTH, self.rect.right)
        self.rect.top = max(HEIGHT // 2, self.rect.top)  # Can't go into top half
...
def main():
    ...
    while running:
        ...
        # Draw boundary line to show player movement limit
