# SOURCE: galaga_progressive_waves.py
# REMIX: add star field background

"""
Galaga - Progressive Difficulty with Star Field

Combines progressive wave difficulty with animated star field background.
Starts with 4 enemies and adds more each wave, while scrolling through space
with a parallax star field effect.
"""
