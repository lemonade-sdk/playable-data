...
BUG FIX: In the Game class's reset() method, shoot_cooldown was assigned as a local 
variable instead of an instance attribute. Change it to self.shoot_cooldown.
"""
...
class Game:
    ...
    def reset(self):
        ...
        self.shoot_cooldown = 0  # Fixed: was missing 'self.'
