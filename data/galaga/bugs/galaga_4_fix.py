...
BUG FIX: In the lives display rendering, the code references lives_remaining which is
not defined. The correct attribute name is session.lives_remaining.
"""
...
def execute_game():
    ...
    while is_running:
        ...
        lives_label = text_font.render(f"Lives: {session.lives_remaining}", True, COLOR_SHIP)  # Fixed: was lives_remaining
