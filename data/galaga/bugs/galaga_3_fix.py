...
BUG FIX: In the ammo display rendering, the code tries to concatenate strings with
game.ammo which is an integer. Convert game.ammo to a string or use an f-string.
"""
...
def main():
    ...
    while active:
        ...
        ammo_display = ui_font.render(f"Ammo: {game.ammo}/5", True, MAIN_COLOR)  # Fixed: was string concatenation with int
