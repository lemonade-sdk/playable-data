# CREATE: galaga
# ERROR:   File "C:\work\lsdk\playable-data\data\galaga\bugs\galaga_2_bug.py", line 234
# ERROR:     game.dive_timer = random.randint(70, 150
# ERROR:                                           ^
    ...
    while running:
        ...
        if not game.ended:
            ...
            if game.dive_timer <= 0 and game.invaders:
                game.dive_timer = random.randint(70, 150
