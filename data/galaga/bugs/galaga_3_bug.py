...
# ERROR:   File "C:\work\lsdk\playable-data\data\galaga\bugs\galaga_3_bug.py", line 326, in <module>
# ERROR:     main()
# ERROR:   File "C:\work\lsdk\playable-data\data\galaga\bugs\galaga_3_bug.py", line 308, in main
# ERROR:     ammo_display = ui_font.render("Ammo: " + game.ammo + "/5", True, MAIN_COLOR)
# ERROR:                                    ~~~~~~~~~^~~~~~~~~~~
...
def main():
    ...
    while active:
        ...
        ammo_display = ui_font.render("Ammo: " + game.ammo + "/5", True, MAIN_COLOR)
