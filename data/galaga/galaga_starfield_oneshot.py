# CREATE: galaga with star field in the background

"""
Galaga - Star Field

A complete Galaga implementation featuring an animated star field background that scrolls
continuously, creating a sense of movement through space with parallax effect. The player
controls a ship at the bottom, shooting at enemies that move in formation and occasionally
dive-bomb. Features sprite-based collision detection.
"""
