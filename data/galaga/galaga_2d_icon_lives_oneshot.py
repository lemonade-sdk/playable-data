# CREATE: galaga with 2D movement and icon lives

"""
Galaga - 2D Movement with Icon Lives

A complete Galaga implementation featuring free 2D player movement allowing navigation
in all directions through the bottom half of the screen, with remaining lives displayed
as mini ship icons at the bottom. Enemy ships perform swooping attack patterns while
the player has full mobility to dodge and shoot.
"""
