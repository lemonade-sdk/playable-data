# CREATE: galaga with exploding bullets and icon lives

"""
Galaga - Exploding Bullets with Icon Lives

A complete Galaga implementation featuring explosive bullet mechanics that create blast radius
explosions capable of destroying multiple enemies, with remaining lives displayed as mini ship
icons at the bottom of the screen. Enemy ships perform swooping attack patterns.
"""
