...
This remix is based on the original breakout.py game, with the key modification being that the ball's speed
increases each time it collides with the paddle.
