# CREATE: breakout with moving bricks and power-ups

"""
Breakout Moving Power Game

A brick-breaking game where the player controls a paddle to bounce a ball and destroy
bricks that move side to side while some contain power-ups that enhance gameplay.
Bricks oscillate horizontally creating dynamic targets, and special power-up bricks
provide effects like bigger paddle, bonus points, or enhanced abilities. Implementation
uses pygame with moving brick mechanics, power-up systems, oscillation patterns,
