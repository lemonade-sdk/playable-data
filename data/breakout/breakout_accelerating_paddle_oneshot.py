# CREATE: breakout where both the ball and paddle accelerate

"""
Breakout Accelerating Paddle Game

A brick-breaking game where the player controls a paddle that increases in movement speed
while the ball also gets faster each time it hits the paddle. Creates escalating challenge
where both ball speed and paddle sensitivity increase together, requiring enhanced control
and precision. Implementation uses pygame with dual acceleration mechanics, collision
