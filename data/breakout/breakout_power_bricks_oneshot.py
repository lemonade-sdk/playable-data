# CREATE: breakout with power-up bricks

"""
Breakout Power Bricks Game

A brick-breaking game where the player controls a paddle to bounce a ball and destroy
bricks, with special power-up bricks that provide gameplay enhancements. Power-up bricks
are visually distinct and grant effects like bigger paddle, faster ball, or bonus points
when destroyed. Implementation uses pygame with power-up systems, collision detection,
and enhanced brick mechanics.
"""
...
class Brick:
    def __init__(self, x, y, color, power_type=None):
        ...
        self.color = color
        self.power_type = power_type  # None, 'big_paddle', 'fast_ball', 'bonus_points'
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Breakout - Power Bricks Remix")
    ...
    def draw(self):
        ...
        if self.paddle.big_paddle_timer > 0:
            ...
            y_offset += 30
        if self.ball.fast_ball_timer > 0:
