# CREATE: breakout with power-up bricks and multiple balls

"""
Breakout Power Multiball Game

A brick-breaking game where the player controls a paddle to bounce multiple balls
and destroy bricks, with special power-up bricks that provide gameplay enhancements.
Power-up bricks grant effects like bigger paddle, bonus points, or spawn additional
balls. Multiple balls can be in play simultaneously through power-up activation.
Implementation uses pygame with power-up systems, multiple ball physics, periodic
ball spawning, and collision detection.
"""
