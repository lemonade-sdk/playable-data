# CREATE: breakout where the paddle can move in 2 dimensions

"""
Breakout 2D Paddle Game

A brick-breaking game where the player controls a paddle that can move in both horizontal
and vertical directions instead of just horizontally. The paddle can move up and down
as well as left and right, providing enhanced control over ball positioning and angles.
Implementation uses pygame with 2D movement controls, collision detection, and physics
simulation for improved paddle positioning strategy.
"""
