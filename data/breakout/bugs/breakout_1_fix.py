...
Fix: In the render method, the code was calling paddle.render() but the Paddle class only has a draw() method.
...
class Game:
    ...
    def render(self):
        ...
        self.paddle.draw(self.screen)  # Fixed: changed render() to draw()
