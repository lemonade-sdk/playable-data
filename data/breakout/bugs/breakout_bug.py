...
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_bug.py", line 240, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_bug.py", line 230, in run
# ERROR:     self.update()
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_bug.py", line 173, in update
# ERROR:     if not brick.is_destroyed and self.ball.get_rect().colliderect(
# ERROR:            ^^^^^^^^^^^^^^^^^^
# ERROR: AttributeError: 'Brick' object has no attribute 'is_destroyed'. Did you mean: 'destroyed'?
...
or the ball falls below the paddle. Uses simple physics and collision detection.
    ...
    def update(self):
        if not self.game_over:
            ...
            for brick in self.bricks:
                if not brick.is_destroyed and self.ball.get_rect().colliderect(
                    brick.get_rect()
                ):
