...
Fix: In the tick method, the code was checking self.game_over, but the game state attribute is named self.finished.
...
class BreakoutGame:
    ...
    def tick(self):
        if not self.finished:  # Fixed: changed game_over to finished
