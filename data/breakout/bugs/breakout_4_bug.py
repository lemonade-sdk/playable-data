...
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_4_bug.py", line 265, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_4_bug.py", line 255, in run
# ERROR:     self.tick()
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_4_bug.py", line 180, in tick
# ERROR:     if not self.game_over:
# ERROR:            ^^^^^^^^^^^^^^
# ERROR: AttributeError: 'BreakoutGame' object has no attribute 'game_over'
    ...
    def create_brick_grid(self):
        ...
        for row_idx in range(self.NUM_ROWS):
            for col_idx in range(self.NUM_COLS):
                ...
                new_brick = Brick(brick_x, brick_y, self.BRICK_W, self.BRICK_H, brick_color)
