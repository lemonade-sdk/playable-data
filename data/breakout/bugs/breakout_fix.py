...
Fix: In the update method, the ball-brick collision check was using the wrong attribute name.
The Brick class defines the attribute as 'destroyed', not 'is_destroyed'.
"""
    ...
    def update(self):
        if not self.game_over:
            ...
            for brick in self.bricks:
                if not brick.destroyed and self.ball.get_rect().colliderect(  # Fixed: changed is_destroyed to destroyed
                    brick.get_rect()
                ):
