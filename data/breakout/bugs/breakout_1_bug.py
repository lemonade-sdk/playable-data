...
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_1_bug.py", line 223, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_1_bug.py", line 214, in run
# ERROR:     self.render()
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_1_bug.py", line 183, in render
# ERROR:     self.paddle.render(self.screen)
# ERROR:     ^^^^^^^^^^^^^^^^^^
# ERROR: AttributeError: 'Paddle' object has no attribute 'render'
