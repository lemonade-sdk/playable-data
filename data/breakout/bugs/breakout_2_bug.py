...
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_2_bug.py", line 260, in <module>
# ERROR:     game = Game()
# ERROR:            ^^^^^^
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_2_bug.py", line 131, in __init__
# ERROR:     self.initialize_game()
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_2_bug.py", line 140, in initialize_game
# ERROR:     self.setup_bricks()
# ERROR:   File "C:\work\lsdk\playable-data\data\breakout\bugs\breakout_2_bug.py", line 153, in setup_bricks
# ERROR:     color = brick_colors[row % len(colors)]
# ERROR:                                    ^^^^^^
# ERROR: NameError: name 'colors' is not defined. Did you mean: 'color'?
...
class Game:
    ...
    def setup_bricks(self):
        brick_colors = [RED, ORANGE, YELLOW, YELLOW, BLUE, PURPLE, PURPLE]
        ...
        for row in range(BRICK_ROWS):
            for col in range(BRICK_COLS):
                ...
                color = brick_colors[row % len(colors)]
