# CREATE: breakout where the paddle moves in 2D and the bricks move

"""
Breakout 2D Moving Game

A brick-breaking game where the player controls a paddle that can move in both horizontal
and vertical directions, while bricks slowly move side to side. Creates dynamic gameplay
where both player and targets are mobile, requiring enhanced positioning and prediction
skills. Implementation uses pygame with 2D paddle controls, moving brick mechanics,
