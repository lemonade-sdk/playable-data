# CREATE: flappy bird where the bird grows and pipes scale as I score

"""
Flappy Bird Growing Scaling Game

A side-scrolling game where the player controls a bird that increases in size with each
point scored while navigating through pipes that dynamically scale and stretch as they
move across the screen. The bird falls due to gravity and flaps upward when spacebar
is pressed. Creates escalating difficulty through both increasing bird size and morphing
pipe obstacles. Implementation uses pygame with size scaling mechanics, dynamic pipe
morphing, collision detection, and physics simulation.
"""
