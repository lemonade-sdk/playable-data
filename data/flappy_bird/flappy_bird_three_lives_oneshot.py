# CREATE: flappy bird with 3 lives

"""
Flappy Bird Three Lives Game

A side-scrolling game where the player controls a bird that must navigate through pipe gaps
with a three-lives system. The bird falls due to gravity and flaps upward when spacebar
is pressed. After collision, the bird respawns at the starting position with lives decremented.
Game ends when all three lives are exhausted. Implementation uses pygame with life tracking,
respawn mechanics, and collision detection.
"""
