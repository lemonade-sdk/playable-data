...
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_4_bug.py", line 204, in <module>
# ERROR:     game = Game()
# ERROR:            ^^^^^^
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_4_bug.py", line 101, in __init__
# ERROR:     self.restart_game()
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_4_bug.py", line 104, in restart_game
# ERROR:     self.bird = Bird(screen_width, screen_height)
# ERROR:                      ^^^^^^^^^^^^
# ERROR: NameError: name 'screen_width' is not defined
...
class Game:
    ...
    def restart_game(self):
        self.bird = Bird(screen_width, screen_height)
