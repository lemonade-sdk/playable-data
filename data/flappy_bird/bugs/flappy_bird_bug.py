...
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_bug.py", line 197, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_bug.py", line 188, in run
# ERROR:     self.draw()
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_bug.py", line 161, in draw
# ERROR:     score_text = self.font.render(f"Score: {self.current_score}", True, WHITE)
# ERROR:                                             ^^^^^^^^^^^^^^^^^^
# ERROR: AttributeError: 'Game' object has no attribute 'current_score'

"""
Flappy Bird - A simple side-scrolling game where the player controls a bird that must navigate through pipes.
