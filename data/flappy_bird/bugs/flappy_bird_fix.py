...
Fix: In the draw method, the score attribute name should match what's defined in reset_game (self.score not self.current_score).
"""
...
class Game:
    ...
    def draw(self):
        ...
        # Draw score
        score_text = self.font.render(f"Score: {self.score}", True, WHITE)  # Fixed: Use self.score instead of self.current_score
