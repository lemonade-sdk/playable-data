...
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_2_bug.py", line 187, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_2_bug.py", line 178, in run
# ERROR:     self.draw_game()
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_2_bug.py", line 146, in draw_game
# ERROR:     self.bird.render(self.screen)
# ERROR:     ^^^^^^^^^^^^^^^^
# ERROR: AttributeError: 'Bird' object has no attribute 'render'
