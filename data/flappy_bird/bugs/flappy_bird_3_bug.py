...
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_3_bug.py", line 199, in <module>
# ERROR:     game.run()
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_3_bug.py", line 190, in run
# ERROR:     self.draw_screen()
# ERROR:   File "C:\work\lsdk\playable-data\data\flappy_bird\bugs\flappy_bird_3_bug.py", line 163, in draw_screen
# ERROR:     score_surf = self.text_font.render("Score: " + self.current_score, True, WHITE)
# ERROR:                                        ~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~
...
class FlappyBirdGame:
    ...
    def draw_screen(self):
        ...
        # Render score
        score_surf = self.text_font.render("Score: " + self.current_score, True, WHITE)
