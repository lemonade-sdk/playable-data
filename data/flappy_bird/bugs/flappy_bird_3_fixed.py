...
Fix: In the draw_screen method, convert the integer score to a string using str() before concatenating with the string.
"""
...
class FlappyBirdGame:
    ...
    def draw_screen(self):
        ...
        # Render score
        score_surf = self.text_font.render("Score: " + str(self.current_score), True, WHITE)  # Fixed: Convert int to str
