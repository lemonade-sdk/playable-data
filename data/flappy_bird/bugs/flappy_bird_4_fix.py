...
Fix: In the restart_game method, use the class constant self.SCREEN_SIZE instead of undefined variables screen_width and screen_height.
"""
...
class Game:
    ...
    def restart_game(self):
        self.bird = Bird(self.SCREEN_SIZE, self.SCREEN_SIZE)  # Fixed: Use self.SCREEN_SIZE
