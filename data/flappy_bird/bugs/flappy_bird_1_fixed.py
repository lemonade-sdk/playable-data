...
Fix: In the update_high_score method, declare high_score as global before modifying it to avoid UnboundLocalError.
"""
...
class Game:
    ...
    def update_high_score(self):
        global high_score  # Fixed: Declare global before modifying
