...
This remix adds golden coins that spawn between pipes for bonus points, plus a 3-lives system that allows
players to continue after collisions by respawning at the starting position.

This remix combines features from flappy_bird_coins.py and flappy_bird_three_lives.py,
creating a more forgiving game with bonus scoring opportunities.
