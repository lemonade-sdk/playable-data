# CREATE: flappy bird with collectible coins

"""
Flappy Bird Coins Game

A side-scrolling game where the player controls a bird that must navigate through pipe gaps
while collecting coins for bonus points. The bird falls due to gravity and flaps upward when
spacebar is pressed. Coins spawn between pipes and award additional score when collected.
Implementation uses pygame with collision detection, coin spawning mechanics, and physics simulation.
"""
